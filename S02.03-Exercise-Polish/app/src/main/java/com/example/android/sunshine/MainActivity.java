...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorDisplayTV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorDisplayTV = findViewById(R.id.errorTV);

        // TODO (17) Find the ProgressBar using findViewById
        mloadingBar = findViewById(R.id.loadingV);
    ...
    public void showWeatherDataView(){
        mErrorDisplayTV.setVisibility(View.INVISIBLE);
    ...
    public void showErrorMessage(){
        ...
        mErrorDisplayTV.setVisibility(View.VISIBLE);
    }
